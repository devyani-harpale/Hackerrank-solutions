'''Integers in Python can be as big as the bytes in your machine's memory. There is no limit in size as there is: 231-1 (c++ int) or
263-1 (C++ long long int).
...
1 <= d <= 1000
Output Format
Print the result of a + cd on one line.
Sample Input
9
29
7
