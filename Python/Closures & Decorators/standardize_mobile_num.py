...
+91 98756 41230
Concept
Like most other programming languages, Python has the concept of closures. Extending these closures gives us decorators, which are an invaluable
asset. You can learn about decorators in 12 easy steps here.
...
def wrapper(f):
    def fun(l):
        ...
        for _ in l:
            last_10_nums = _[-10:]
            result.append(f"+91 {last_10_nums[:5]} {last_10_nums[5:]}")
        f(result)
    return fun
